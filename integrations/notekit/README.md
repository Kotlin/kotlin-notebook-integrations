...
[![Maven Central](https://img.shields.io/maven-central/v/org.jetbrains.kotlinx/kotlin-jupyter-notekit-jupyter?color=blue&label=Maven%20Central)](https://central.sonatype.com/artifact/org.jetbrains.kotlinx/kotlin-jupyter-notekit-jupyter)
...
notekit { insertCell(2, newCodeCell) }
...
notekit { replaceCell(1, markdownCell) }
...
- Jupyter frontend that implements the notekit protocol (e.g., IntelliJ IDEA with Kotlin Notebook plugin)
- Kotlin Jupyter kernel

## Module Structure

- `notekit-api` - Core API and implementation
- `notekit-jupyter` - Jupyter integration layer

## Error Handling

All operations throw `NotekitException` if they fail. Common error scenarios:
