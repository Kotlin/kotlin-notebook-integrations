...
This document describes the protocol for notebook operations via Jupyter Comms.

## Overview

The Notekit protocol enables programmatic operations on Jupyter notebooks from kernel code. It uses the Jupyter Comms infrastructure to send requests from the kernel to the frontend and receive responses.

**Target Name**: `jupyter.notekit.v1`
...
1. **Initialization:**
   - The kernel integration opens a comm with target `jupyter.notekit.v1`
