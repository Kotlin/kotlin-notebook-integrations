...
/**
 * Main API for manipulating the current Jupyter notebook.
 *
 ...
 */
public interface NotebookManipulator {
    /**
     * Returns the total number of cells in the current notebook.
     *
     * @return The cell count
     * @throws NotebookManipulatorException if the operation fails
     */
     ...
     * @throws NotebookManipulatorException if the operation fails or range is invalid
     */
     ...
     * @throws NotebookManipulatorException if the operation fails or index is invalid
     */
     ...
     * @throws NotebookManipulatorException if the operation fails or parameters are invalid
     */
     ...
     * @throws NotebookManipulatorException if the operation fails or start index is invalid
     */
