...
import org.jetbrains.kotlinx.jupyter.notebook.integration.ManipulationResult
...
abstract class AbstractNotebookManipulatorReplTest(
    ...
    provider: IntegrationReplProvider = IntegrationReplProvider(commManager, "notebook-manipulator"),
    ...
    protected fun manipulate(code: String): ManipulationResult<*> =
        execRaw(
            """
            manipulateNotebook {
                $code
     ...
     */
    protected inline fun <reified T> awaitAsyncResult(result: ManipulationResult<*>): T = result.result as T
}
