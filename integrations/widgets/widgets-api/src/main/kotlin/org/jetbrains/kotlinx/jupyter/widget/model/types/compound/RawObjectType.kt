...
public object RawObjectType : AbstractWidgetModelPropertyType<Map<String, Any?>>("object") {
    ...
    override fun serialize(propertyValue: Map<String, Any?>, widgetManager: WidgetManager): Any? = propertyValue

    @Suppress("UNCHECKED_CAST")
    override fun deserialize(patchValue: Any?, widgetManager: WidgetManager): Map<String, Any?> {
